...
//         {/* Navigation Links */}
//         <motion.div
//           className="flex gap-6 text-sm flex-nowrap overflow-x-auto whitespace-nowrap"
//           initial={{ opacity: 0 }}
//           whileInView={{ opacity: 1 }}
//           transition={{ duration: 0.6, delay: 0.2 }}
//         >
//           {["hero", "about", "skills", "projects","experience", "contact"].map((item, index) => (
//             <Link
//               key={index}
//               to={item}
//               smooth={true}
...
//           </a>
//           <a
//             href="mailto:anurag7276singh@gmail.com"
...
//         <span className="text-cyan-400 font-medium">Anurag Singh</span>
//       </motion.div>
//     </footer>
//   );
// }
