...
function About() {
  ...
  <div className="mx-auto md:mx-0 mt-2 h-[3px] w-24 bg-cyan-400 rounded-full animate-pulse-left-glow"></div>
          ...
          <p className="text-gray-300 text-lg sm:text-xl leading-relaxed">
            I'm <span className="text-white font-semibold">Anurag Singh</span>, a dedicated 
...
<br/>
 ...
 <span className="text-white font-semibold">TestGenius –</span> AI-powered test case generator integrated with GitHub for automated code analysis and test creation.<br/>

<span className="text-white font-semibold">TicketGenius –</span> AI-driven ticketing system for smart ticket triage, assignment, and resolution.<br/>

<span className="text-white font-semibold">StudyNotion –</span> Full-stack ed-tech platform with interactive courses and smooth UI/UX.<br/>
          </p>
