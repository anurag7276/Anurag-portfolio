...
const projects = [
  {
    title: "TestGenius",
    description: "AI-powered test case generator integrated with GitHub for automated code analysis and test creation.",
    image: "/images/testgenius.png",
    github: "https://github.com/anurag7276/TestGenius-Hosting.git",
    live: "https://test-genius-hosting.vercel.app",
  },
  {
    title: "TicketGenius",
    description: "AI-powered ticketing system using MERN, Gemini, and Inngest for smart triage.",
    image: "/images/ticketgenius.png",
    github: "https://github.com/anurag7276/Ticket_Genius_Hosting.git",
